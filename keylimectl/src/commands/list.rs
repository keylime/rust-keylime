...
/// println!("Found {} agents", result["results"].as_object().unwrap().len()); //#[allow_ci]
///
/// // List policies
/// let policies = ListResource::Policies;
/// let result = list::execute(&policies, &config, &output).await?;
...
mod tests {
    ...
    mod resource_variants {
        ...
        fn test_agents_basic_resource() {
            ...
            match resource {
                ...
                _ => panic!("Expected Agents resource"), //#[allow_ci]
            }
        }
        ...
        fn test_policies_resource() {
            ...
            match resource {
                ...
                _ => panic!("Expected Policies resource"), //#[allow_ci]
            }
        }
        ...
        fn test_measured_boot_policies_resource() {
            ...
            match resource {
                ...
                _ => panic!("Expected MeasuredBootPolicies resource"), //#[allow_ci]
            }
        }
    }
    ...
    mod json_responses {
        ...
        fn test_basic_agent_list_response_structure() {
            ...
            let results = response["results"].as_object().unwrap(); //#[allow_ci]
        ...
        fn test_detailed_agent_list_response_structure() {
            ...
            let verifier_results =
                response["verifier"]["results"].as_object().unwrap(); //#[allow_ci]
            let registrar_results =
                response["registrar"]["results"].as_object().unwrap(); //#[allow_ci]
    ...
    mod listing_scenarios {
        ...
        fn test_empty_agent_list() {
            ...
            let results = empty_response["results"].as_object().unwrap(); //#[allow_ci]
            assert_eq!(results.len(), 0);
        }
        ...
        fn test_single_agent_list() {
            ...
            let results =
                single_agent_response["results"].as_object().unwrap(); //#[allow_ci]
        ...
        fn test_multiple_agents_list() {
            ...
            let results =
                multiple_agents_response["results"].as_object().unwrap(); //#[allow_ci]
        ...
        fn test_large_scale_agent_list_structure() {
            ...
            let results = large_response["results"].as_object().unwrap(); //#[allow_ci]
            ...
            for (uuid, state) in results {
                ...
                let state_str = state.as_str().unwrap(); //#[allow_ci]
    ...
    mod performance_tests {
        ...
        fn test_response_size_estimation() {
            ...
            let response_str =
                serde_json::to_string(&detailed_agent).unwrap(); //#[allow_ci]
        ...
        fn test_basic_vs_detailed_response_difference() {
            ...
            let basic_size =
                serde_json::to_string(&basic_agent).unwrap().len(); //#[allow_ci]
            let detailed_size =
                serde_json::to_string(&detailed_agent).unwrap().len(); //#[allow_ci]
